...
BASEMAPS = {
    "Gelap (Esri Dark Gray Canvas)": {
        "tiles": "https://server.arcgisonline.com/ArcGIS/rest/services/"
                 "Canvas/World_Dark_Gray_Base/MapServer/tile/{z}/{y}/{x}",
        "attr": "Tiles &copy; Esri — Esri, HERE, Garmin, © OpenStreetMap "
                "contributors, and the GIS User Community",
    },
    "Terang (Esri Light Gray Canvas)": {
        "tiles": "https://server.arcgisonline.com/ArcGIS/rest/services/"
...
DEFAULT_BASEMAP = "Gelap (Esri Dark Gray Canvas)"
