...
def set_background_image(image_path, position="center", opacity=0.15):
    """Set background image untuk halaman"""
    if os.path.exists(image_path):
        try:
            ...
            st.warning(f"Tidak dapat memuat background: {e}")
            return False
    return False
...
# Set background utama dengan Balai-kota-malang.jpg
set_background_image("images/Balai-kota-malang.jpg", position="center", opacity=0.1)
