    ...
    if foto:
        ...
        if source_url:
            img_html += (
                ...
                'style="color:#2e7d32;text-decoration:none;">📷 Lihat folder foto di GitHub</a></div>'
            )
    elif source_url:
        img_html = (
            ...
            f'📷 Foto untuk node {kode} belum ditemukan di repository<br>'
            f'<a href="{html.escape(source_url)}" target="_blank" rel="noopener noreferrer" '
            'style="color:#2e7d32;font-weight:700;text-decoration:none;">Buka folder foto GitHub</a>'
            '</div>'
        )
    else:
        img_html = ''
